...
public class BitingotItem extends AllModElements.ModElement {
	@ObjectHolder("all:bitingot")
	public static final Item block = null;
	public BitingotItem(AllModElements instance) {
		super(instance, 2);
	}
